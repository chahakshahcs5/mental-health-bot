...
This is a simple Flask web application that helps to chat with the AI bot regarding mental health issues.
...
Create a MongoDB database named mental_health and a collection named users where your data will be stored.
...
templates/index.html: HTML template for rendering the main chat page.
License
